...
public class OutgoingInvoiceUpdateView extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OutgoingInvoiceUpdateView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                OutgoingInvoiceUpdateView dialog = new OutgoingInvoiceUpdateView(new javax.swing.JFrame(), true);
